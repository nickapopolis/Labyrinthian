...
void AudioPlayer::playSound()
{
	...
	currentSound = soundEngine->play3D(fileName.c_str(),vec3df(0,0,0),true, false, true);
...
void AudioPlayer::playSound(int milliseconds)
{
	...
	currentSound = soundEngine->play3D(fileName.c_str(),vec3df(0,0,0),false, false, true);
    if(!currentSound)
    {
        cout << "Error: Could not play file" << endl;
        exit(0);
...
void AudioPlayer::playSound(string soundFile)
{
	...
	currentSound = soundEngine->play3D(fileName.c_str(),vec3df(0,0,0),true, false, false);
...
{
	currentSound = soundEngine->play3D("walk.mav",vec3df(0,0,0),false, false, true);
    if(!currentSound)
    {
        cout << "Error: Could not play file" << endl;
        exit(0);
